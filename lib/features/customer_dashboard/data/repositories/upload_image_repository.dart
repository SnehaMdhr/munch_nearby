...
import 'package:munch_nearby/features/customer_dashboard/data/datasources/remote/upload_image_remote_datasource.dart';
...
final uploadImageRepositoryProvider = Provider<IUploadImageRepository>((ref) {
  ...
  final uploadImageRemoteDatasource = ref.read(uploadImageRemoteDatasourceProvider);
  return UploadImageRepository(networkInfo: networkInfo, uplaodImageRemoteDataSource: uploadImageRemoteDatasource);
});
...
class UploadImageRepository implements IUploadImageRepository {
  ...
  UploadImageRepository({required NetworkInfo networkInfo,required IUploadImageRemoteDatasource uplaodImageRemoteDataSource})
