...
import 'package:munch_nearby/features/profile/domain/entities/upload_image_entity.dart';
...
class UploadImageHiveModel extends HiveObject {
  ...
  UploadImageHiveModel({this.media, this.mediaType});

  UploadImageEntity toEntity() {
    return UploadImageEntity(media: media, mediaType: mediaType);
  }
  ...
  static List<UploadImageEntity> toEntityList(
    List<UploadImageHiveModel> models,
  ) {
